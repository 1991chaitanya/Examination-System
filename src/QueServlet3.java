...
public class QueServlet3 extends HttpServlet
{
	...
	public void service(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException 
	{
	   ...
	   try
	   {
		   ...
		   rs=stmt.executeQuery("select comment,op1,op2,op3,op4 from comment where no=3");
		   if(rs.next()==true)
		   {
			   out.println("<html>");
			   out.println("<head>");
			   ...
			   out.println("<br>");
			   out.println("<br>");
			   out.println("<form method=\"post\" action=\"http://localhost:8080/ExaminationSoftware/QueServlet4\">");
