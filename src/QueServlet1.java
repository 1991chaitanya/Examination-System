...
public class QueServlet1 extends HttpServlet
{
	...
	public void service(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException 
	{
	   ...
	   try
	   {
		   ...
		   rs=stmt.executeQuery("select comment,op1,op2,op3,op4 from comment where no=1");
		   if(rs.next()==true)
		   {
			 str=rs.getString("op1");
			 System.out.println(str);
			   out.println("<html>");
			   out.println("<head>");
			   out.println("<h2>");
			   out.println("QUESTION NO 1");
			   out.println("</h2>");
			   out.println("</head>");
			   out.println("<body>");
			   ...
			   out.println("<br>");
			   out.println("<br>");
			   out.println("<form method=\"post\" action=\"http://localhost:8080/ExaminationSoftware/QueServlet2\">");
